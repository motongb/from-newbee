...
public class NeeBeeMallWebMvcConfigurer implements WebMvcConfigurer {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        registry.addResourceHandler("/upload/**").addResourceLocations("file:" + apiConfig.getUploadPath());
        registry.addResourceHandler("/goods-img/**").addResourceLocations("file:" + apiConfig.getUploadPath());
    }
}
